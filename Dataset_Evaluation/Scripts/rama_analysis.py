...
if __name__ == "__main__":
    ...
    parser.add_argument('list_file', type=str, help='Path to the file containing PDB file paths.')
    ...
    if not os.path.isfile(args.list_file):
        print(f"Error: The specified list file {args.list_file} does not exist.")
        sys.exit(1)
