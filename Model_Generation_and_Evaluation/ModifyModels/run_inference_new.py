...
class PepGenDataset(PdbDataset):
    def __init__(
        ...
        self.pdb_length_df = pd.read_csv(csv_file_path)  # 读取 CSV 文件
...
class Sampler(Experiment):
    ...
    def run_sampling(self):
        ...
        # We hard-code csv file path here
        csv_file_path = "/home/fit/liulei/WORK/LNR/TestSet0924/LNR_length_0924.csv" 
