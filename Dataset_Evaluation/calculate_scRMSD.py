...
def process_pdb_files(folder1, folder2, output_csv):
...
def main():
    parser = argparse.ArgumentParser(description='Calculate CA atom RMSD values and pLDDT averages for PDB files in two folders')
    ...
    process_pdb_files(args.folder1, args.folder2, args.output)
